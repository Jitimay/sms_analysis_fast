...
void loop() {
  ...
  if (!client.connect(server, 80)) {
    ...
    // Correct function selector for latestCommand()
    String payload = "{\"jsonrpc\":\"2.0\",\"method\":\"eth_call\",\"params\":[{\"to\":\"" + String(contractAddress) + "\",\"data\":\"0x3d91efcf\"},\"latest\"],\"id\":1}";
    ...
    // Skip headers, show only JSON response
