...
class InsecureClient : public TinyGsmClient {
public:
  InsecureClient(TinyGsm& modem) : TinyGsmClient(modem) {}
  
  int connect(const char* host, uint16_t port) override {
    // Use AT+CIPSSL=1 for SSL without certificate verification
