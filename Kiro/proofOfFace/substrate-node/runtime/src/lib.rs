...
/// Import the ProofOfFace pallet.
pub use pallet_proofofface;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("proofofface"),
	impl_name: create_runtime_str!("proofofface"),
	authoring_version: 1,
...
/// Configure the ProofOfFace pallet in pallets/proofofface.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Sudo: pallet_sudo,
		// Include the ProofOfFace pallet.
