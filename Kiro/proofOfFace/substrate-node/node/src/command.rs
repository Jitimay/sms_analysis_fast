...
use proofofface_runtime::{Block, EXISTENTIAL_DEPOSIT};
...
fn inherent_benchmark_data() -> Result<
...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/proofofface/proofofface/issues/new".into()
	}
